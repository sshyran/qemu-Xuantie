...
struct vdsp_reg dst0[] = {
    {
        .float32 = {0x4695dc00, 0x46815400, 0x47452400, 0x468d5200, },
...
struct vdsp_reg dst1[] = {
    {
        .float32 = {0x4694ca00, 0x46809c00, 0x4744bf00, 0x468c4c00, },
        .float16 = {0x1bb, 0x4a, 0xff5c, 0xd5, 0x199, 0x44, 0xff69, 0xc4, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vitof.u16.f32\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vitof_u16_f32(src0[i].float16, src1[i].float32, src2[i].float32);
