...
int main(void)
{
    init_testsuite("Testing insn vldm.t\n");

    test_vldm_32(src0[0].dspi, res[0].dspi, sizeof(union VDSP));
    ...
    test_vldm_16(src0[0].dsps, res[0].dsps, sizeof(union VDSP));
    ...
    test_vldm_8(src0[0].dspc, res[0].dspc, sizeof(union VDSP));
