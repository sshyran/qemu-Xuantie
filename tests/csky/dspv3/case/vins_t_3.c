...
struct vdsp_reg src[] = {
    ...
    {
        .fixs32 = {0x15fc5221, 0xf1bfac15, 0x67e3b37f, 0x12df3e7c, },
        .fixs16 = {0x10ef, 0x39b3, 0x6744, 0xfa98, 0xce81, 0x997d, 0x301c, 0xcfb5, },
        .fixs8 = { 0x8c, 0xb6, 0x8d, 0x3a, 0xe2, 0x09, 0x90, 0x15, 0x2c, 0x13, 0xac, 0x86, 0x28, 0xce, 0x4f, 0xbb, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vins.t.3\n");

    for (i = 0; i < sizeof(dst0) / sizeof(struct vdsp_reg); i++) {
        test_vins_8_3(src[5 * i].fixs8, res[0].fixs8);
    ...
    for (i = 0; i < sizeof(dst0) / sizeof(struct vdsp_reg); i++) {
        test_vins_16_3(src[5 * i].fixs16, res[0].fixs16);
    ...
    for (i = 0; i < sizeof(dst0) / sizeof(struct vdsp_reg); i++) {
        test_vins_32_3(src[5 * i].fixs32, res[0].fixs32);
