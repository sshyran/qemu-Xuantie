...
struct vdsp_reg res[1];

int main(void)
{
    int i = 0;
    init_testsuite("Testing insn vins.t.1\n");

    test_vins_8_1(src[0].fixs8, res[0].fixs8);
    result_compare_s8(res[0].fixs8, dst[i].fixs8);

    test_vins_16_1(src[0].fixs16, res[0].fixs16);
    result_compare_s16(res[0].fixs16, dst[i].fixs16);

    test_vins_32_1(src[0].fixs32, res[0].fixs32);
    result_compare_s32(res[0].fixs32, dst[i].fixs32);
