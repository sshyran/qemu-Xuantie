...
int main(void)
{
    init_testsuite("Testing insn vstmru.t\n");

    TEST(test_vstmru_32(src0[0].dspi, res[0].dspi, 16) == (unsigned int)res[0].dspi + 16 * 4);
    ...
    TEST(test_vstmru_16(src0[0].dsps, res[0].dsps, 16) == (unsigned int)res[0].dsps + 16 * 4);
    ...
    TEST(test_vstmru_8(src0[0].dspc, res[0].dspc, 16) == (unsigned int)res[0].dspc + 16 * 4);
