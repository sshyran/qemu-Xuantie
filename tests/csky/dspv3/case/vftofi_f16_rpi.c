...
struct vdsp_reg dst0[] = {
    {
        ...
        .float16 = {0x4b00, 0x4200, 0xc500, 0x4700, 0x4a80, 0x4200, 0xc400, 0x4700, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vftofi.f16.rpi \n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vftofi_f16_rpi(src0[i].float16, res.float16);
