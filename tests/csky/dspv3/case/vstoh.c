...
struct vdsp_reg dst0[] = {
    {
        .float32 = {0x50e74e3a, 0xd11c12e8, 0xd084291f, 0x4fcd7bd6, },
        .float16 = {0x7c00, 0x7797, 0xfc00, 0x7c00, 0x0, 0x0, 0x0, 0x0, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vstoh\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vstoh_f32(src0[i].float32, src2[i].float16);
