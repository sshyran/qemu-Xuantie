...
struct vdsp_reg dst0[] = {
    {
        .float16 = {0x4ca, 0x4630, 0xc6d6, 0xc984, 0xb07f, 0x45bb, 0xcb8f, 0xc918, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vfmulai.t.e\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vfmulai_f16_e(src0[i].float16, src1[i].float16, src2[i].float16);
