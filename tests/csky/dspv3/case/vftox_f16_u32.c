...
{
    int i = 0;
    init_testsuite("Testing insn vftox.f16.u32\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vftox_f16_u32(src0[i].float16, src1[i].float32, src2[i].float32);
