...
struct vdsp_reg dst0[] = {
    {
        .float32 = {0xd, 0x2, 0xfffffffb, 0x6, },
...
struct vdsp_reg dst1[] = {
    {
        .float32 = {0xc, 0x2, 0xfffffffc, 0x6, },
        .float16 = {0x1bb, 0x4a, 0xff5c, 0xd5, 0x199, 0x44, 0xff69, 0xc4, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vftoi.f16.s32.rz\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vftoi_f16_s32_rz(src0[i].float16, src1[i].float32, src2[i].float32);
