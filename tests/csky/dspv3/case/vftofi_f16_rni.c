...
struct vdsp_reg dst0[] = {
    {
        ...
        .float16 = {0x4a80, 0x4000, 0xc600, 0x4600, 0x4a00, 0x4000, 0xc500, 0x4600, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vftofi.f16.rni\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vftofi_f16_rni(src0[i].float16, res.float16);
