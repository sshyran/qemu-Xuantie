...
struct vdsp_reg dst0[] = {
    {
        .float32 = {0x415dc000, 0x40154000, 0xc0a48000, 0x40d52000, },
        .float16 = {0x59aa, 0xdb2c, 0xd698, 0x4eef, 0x58d6, 0xda18, 0xd5a5, 0x4db7, },
    },
};

struct vdsp_reg dst1[] = {
    {
        .float32 = {0x414ca000, 0x4009c000, 0xc097e000, 0x40c4c000, },
        .float16 = {0x59aa, 0xdb2c, 0xd698, 0x4eef, 0x58d6, 0xda18, 0xd5a5, 0x4db7, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vhtos\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vhtos_f16(src0[i].float16, src1[i].float32, src2[i].float32);
