...
struct vdsp_reg dst0[] = {
    {
        .float32 = {0x4e9068e4, 0x4e8de5c0, 0xce61e88f, 0x4e8f5ad4, },
        .float16 = {0x74af, 0x740b, 0xf35c, 0x746b, 0x74a6, 0x7405, 0xf368, 0x7462, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vitof.s16.f16\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vitof_s16_f16(src0[i].float16, res.float16);
