...
{
    int i = 0;
    init_testsuite("Testing insn vftoi.f16.u32.rpi\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vftoi_f16_u32_rpi(src0[i].float16, src1[i].float32, src2[i].float32);
