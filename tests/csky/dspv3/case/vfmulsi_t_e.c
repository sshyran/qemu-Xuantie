...
struct vdsp_reg dst0[] = {
    {
        .float16 = {0x883e, 0x4636, 0xc4a4, 0xc984, 0xdb89, 0x45b6, 0xbf09, 0xc918, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vfmulsi.t.e\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vfmulsi_f16_e(src0[i].float16, src1[i].float16, src2[i].float16);
