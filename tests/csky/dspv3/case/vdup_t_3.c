...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vdup_8_3(src0[i].fixs8, src1[i].fixs8, res[0].fixs8, sizeof(struct vdsp_reg));
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vdup_16_3(src0[i].fixs16, src1[i].fixs16, res[0].fixs16, sizeof(struct vdsp_reg));
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vdup_32_3(src0[i].fixs32, src1[i].fixs32, res[0].fixs32, sizeof(struct vdsp_reg));
