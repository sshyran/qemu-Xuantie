...
struct vdsp_reg dst0[] = {
    {
        .float32 = {0x4fb2d2b0, 0x4fb9c127, 0x507f5ad2, 0x5084a045, },
        .float16 = {0x5109, 0x5129, 0x55ab, 0x5592, 0x50a6, 0x50c3, 0x553b, 0x5524, },
    },
};
...
int main(void)
{
    ...
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vfmulxsai_f32(src0[i].float32, src1[i].float32, src2[i].float32);
        result_compare_f32(src2[i].float32, dst0[i].float32);
    }

    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vfmulxsai_f16(src0[i].float16, src1[i].float16, src2[i].float16);
