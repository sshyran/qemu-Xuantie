...
int main(void)
{
    init_testsuite("Testing insn vldru.t.n\n");

    TEST(test_vldru_8_1(src0[0].fixs8, src1[0].fixs8, res.fixs8, 4) == (uint32_t)src0->fixs8 + 4);
    result_compare_s8(res.fixs8, dst0[0].fixs8);

    TEST(test_vldru_8_2(src0[0].fixs8, src1[0].fixs8, res.fixs8, 4) == (uint32_t)src0->fixs8 + 4);
    result_compare_s8(res.fixs8, dst0[1].fixs8);

    TEST(test_vldru_8_3(src0[0].fixs8, src1[0].fixs8, res.fixs8, 4) == (uint32_t)src0->fixs8 + 4);
    result_compare_s8(res.fixs8, dst0[2].fixs8);

    TEST(test_vldru_8_4(src0[0].fixs8, src1[0].fixs8, res.fixs8, 4) == (uint32_t)src0->fixs8 + 4);
    result_compare_s8(res.fixs8, dst0[3].fixs8);

    TEST(test_vldru_16_1(src0[0].fixs16, src1[0].fixs16, res.fixs16, 4) ==  (uint32_t)src0->fixs16 + 4);
    result_compare_s16(res.fixs16, dst0[0].fixs16);

    TEST(test_vldru_16_2(src0[0].fixs16, src1[0].fixs16, res.fixs16, 4) ==  (uint32_t)src0->fixs16 + 4);
    result_compare_s16(res.fixs16, dst0[1].fixs16);

    TEST(test_vldru_16_3(src0[0].fixs16, src1[0].fixs16, res.fixs16, 4) ==  (uint32_t)src0->fixs16 + 4);
    result_compare_s16(res.fixs16, dst0[2].fixs16);

    TEST(test_vldru_16_4(src0[0].fixs16, src1[0].fixs16, res.fixs16, 4) ==  (uint32_t)src0->fixs16 + 4);
    result_compare_s16(res.fixs16, dst0[3].fixs16);

    TEST(test_vldru_32_1(src0[0].fixs32, src1[0].fixs32, res.fixs32, 4) ==  (uint32_t)src0->fixs32 + 4);
    result_compare_s32(res.fixs32, dst0[0].fixs32);

    TEST(test_vldru_32_2(src0[0].fixs32, src1[0].fixs32, res.fixs32, 4) ==  (uint32_t)src0->fixs32 + 4);
    result_compare_s32(res.fixs32, dst0[1].fixs32);

    TEST(test_vldru_32_3(src0[0].fixs32, src1[0].fixs32, res.fixs32, 4) ==  (uint32_t)src0->fixs32 + 4);
    result_compare_s32(res.fixs32, dst0[2].fixs32);

    TEST(test_vldru_32_4(src0[0].fixs32, src1[0].fixs32, res.fixs32, 4) ==  (uint32_t)src0->fixs32 + 4);
