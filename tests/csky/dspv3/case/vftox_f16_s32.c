...
struct vdsp_reg dst0[] = {
    {
        .float32 = {0x1bc, 0x4b, 0xffffff5c, 0xd5, },
...
struct vdsp_reg dst1[] = {
    {
        .float32 = {0x199, 0x45, 0xffffff68, 0xc5, },
        .float16 = {0x1bb, 0x4a, 0xff5c, 0xd5, 0x199, 0x44, 0xff69, 0xc4, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vftox.f16.s32\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vftox_f16_s32(src0[i].float16, src1[i].float32, src2[i].float32);
