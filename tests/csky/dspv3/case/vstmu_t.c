...
int main(void)
{
    init_testsuite("Testing insn vstmu.t\n");

    TEST(test_vstmu_32(src0[0].dspi, res[0].dspi, sizeof(union VDSP)) == (unsigned int)res[0].dspi + 16 * 4);
    ...
    TEST(test_vstmu_16(src0[0].dsps, res[0].dsps, sizeof(union VDSP)) == (unsigned int)res[0].dsps + 16 * 4);
    ...
    TEST(test_vstmu_8(src0[0].dspc, res[0].dspc, sizeof(union VDSP)) == (unsigned int)res[0].dspc + 16 * 4);
