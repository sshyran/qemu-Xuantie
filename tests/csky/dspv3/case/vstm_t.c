...
int main(void)
{
    init_testsuite("Testing insn vstm.t\n");

    test_vstm_32(src0[0].dspi, res[0].dspi, sizeof(union VDSP));
    ...
    test_vstm_16(src0[0].dsps, res[0].dsps, sizeof(union VDSP));
    ...
    test_vstm_8(src0[0].dspc, res[0].dspc, sizeof(union VDSP));
