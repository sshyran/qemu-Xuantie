...
int main(void)
{
    init_testsuite("Testing insn vldmu.t\n");
    void *a;
    a = test_vldmu_32(src0[0].dspi, res[0].dspi, sizeof(union VDSP));
    TEST( a == ((void *)&src0[0] + 16 * 4));
    ...
    a = test_vldmu_16(src0[0].dsps, res[0].dsps, sizeof(union VDSP));
    TEST( a == ((void *)&src0[0] + 16 * 4));
    ...
    a = test_vldmu_8(src0[0].dspc, res[0].dspc, sizeof(union VDSP));
    TEST( a == ((void *)&src0[0] + 16 * 4));
