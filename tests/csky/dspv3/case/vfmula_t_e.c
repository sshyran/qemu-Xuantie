...
struct vdsp_reg dst0[] = {
    {
        .float16 = {0x4ca, 0x4630, 0xc4af, 0xc984, 0xd9f8, 0x45b9, 0xc038, 0xc918, },
    },
};
...
{
    int i = 0;
    init_testsuite("Testing insn vfmula.t.e\n");

#ifdef VDSP_FLOAT
    for (i = 0; i < sizeof(src0) / sizeof(struct vdsp_reg); i++) {
        test_vfmula_f16_e(src0[i].float16, src1[i].float16, src2[i].float16);
