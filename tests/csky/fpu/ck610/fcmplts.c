...
void test_fcmplts()
{
        ...
        i++)
    {
        asm ("fmts %1, fr0;\n\t"\
            ...
            "done:\n\t"
            : "=r"(fcmplts_psr)
            : "r"(samples_fcmplts_32[i].op1.a.f),
            "r"(samples_fcmplts_32[i].op2.a.f)
            : "fr0", "fr1", "r2"
        );
        TEST((fcmplts_psr & 0x1)
            == samples_fcmplts_32[i].result.a.ui);
    }
}
...
{
    int i = 0;
    init_testsuite("Testing fpu fcmplts instructions.\n");
    test_fcmplts();
