    ...
    for (i = 0;
        ...
        if (samples_pclipi_s16[i].op2 == 1) {
            ...
            TEST(test_pclipi_s16_2(samples_pclipi_s16[i].op1)
                 == samples_pclipi_s16[i].result);
        } else if (samples_pclipi_s16[i].op2 == 9) {
            TEST(test_pclipi_s16_9(samples_pclipi_s16[i].op1)
                 == samples_pclipi_s16[i].result);
        } else if (samples_pclipi_s16[i].op2 == 15) {
            TEST(test_pclipi_s16_15(samples_pclipi_s16[i].op1)
                 == samples_pclipi_s16[i].result);
        } else if (samples_pclipi_s16[i].op2 == 16) {
            TEST(test_pclipi_s16_16(samples_pclipi_s16[i].op1)
                 == samples_pclipi_s16[i].result);
        }
    }
    return done_testing();
