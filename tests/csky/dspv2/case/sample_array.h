...
struct binary_calculation samples_clipi_s32[] = {
    ...
    {0xffffffff, 0x00000020, 0xffffffff},
    {0xfffffffe, 0x00000020, 0xfffffffe},
    {0x00000001, 0x0000001f, 0x00000001},
    {0xffffffff, 0x00000020, 0xffffffff},
    {0xffffffff, 0x0000001f, 0xffffffff},
    {0x00000000, 0x00000020, 0x00000000},
    {0x7fffffff, 0x0000001f, 0x3fffffff},
    {0x80000000, 0x0000001f, 0xc0000000},
    {0xffffffff, 0x0000001f, 0xffffffff},
    {0x0000001f, 0x00000006, 0x0000001f},
    {0x0000002f, 0x00000006, 0x0000001f},
    {0x0000000f, 0x00000006, 0x0000000f},
    {0xffffffc0, 0x00000006, 0xffffffe0},
    {0xffffffe1, 0x00000006, 0xffffffe1},
};
...
struct binary_calculation samples_pclipi_u16[] = {
    ...
    {0x80008000, 0x00000007, 0x00000000},
};
...
struct binary_calculation samples_pclip_u16[] = {
    ...
    {0x80008000, 0x00000008, 0x00000000},
};
...
struct binary_calculation samples_pclipi_s16[] = {
    ...
    {0xfffe0001, 0x00000001, 0xffff0000},
    {0xfffd0010, 0x00000002, 0xfffe0001},
    {0xfffc0011, 0x00000002, 0xfffe0001},
    {0x00010001, 0x0000000f, 0x00010001},
    {0xffffffff, 0x00000010, 0xffffffff},
    {0xffffffff, 0x0000000f, 0xffffffff},
    {0x00000000, 0x00000010, 0x00000000},
    {0x00000000, 0x0000000f, 0x00000000},
    {0x7fffffff, 0x0000000f, 0x3fffffff},
    {0x80000000, 0x0000000f, 0xc0000000},
    {0x7ffe8001, 0x0000000f, 0x3fffc000},
    {0x000100ff, 0x00000009, 0x000100ff},
    {0x8001fe01, 0x00000009, 0xff00ff00},
    {0xfe01fe01, 0x00000009, 0xff00ff00},
};
